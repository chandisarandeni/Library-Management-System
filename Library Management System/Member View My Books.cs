...
{
    public partial class Member_View_My_Books : Form
    {
        bool slidebarExpand;
        public Member_View_My_Books()
        {
            InitializeComponent();
        ...
        private void Member_View_My_Books_Load(object sender, EventArgs e)
        {
        ...
        private void Member_View_My_Books_MouseClick(object sender, MouseEventArgs e)
        {
