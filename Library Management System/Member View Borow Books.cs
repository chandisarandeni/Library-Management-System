...
{
    public partial class Member_View_Borow_Books : Form
    {
        bool slidebarExpand;
        public Member_View_Borow_Books()
        {
            InitializeComponent();
        ...
        private void Member_View_Borow_Books_Load(object sender, EventArgs e)
        {
    ...
    ORDER BY b.borrowedDate DESC";
        ...
        private void Member_View_Borow_Books_MouseClick(object sender, MouseEventArgs e)
        {
