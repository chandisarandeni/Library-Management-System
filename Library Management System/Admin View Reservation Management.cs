...
{
    public partial class Admin_View_Reservation_Management : Form
    {
        bool slidebarExpand;
        public Admin_View_Reservation_Management()
        {
            InitializeComponent();
        ...
        private void Admin_View_Reservation_Management_Load(object sender, EventArgs e)
        {
        ...
        private void Admin_View_Reservation_Management_MouseClick(object sender, MouseEventArgs e)
        {
        ...
        {
            Admin_View_Book_Management adminViewBookMangement = new Admin_View_Book_Management();
            adminViewBookMangement.Show();
            this.Hide();
        }
